...
namespace WardrobeApp.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomID,BotName,BotColor,BotPhoto")] Bottom bottom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomID,BotName,BotColor,BotPhoto")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
