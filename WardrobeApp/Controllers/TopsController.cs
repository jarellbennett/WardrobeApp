...
namespace WardrobeApp.Controllers
{
    public class TopsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TopID,TopName,TopColor,TopPhoto")] Top top)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TopID,TopName,TopColor,TopPhoto")] Top top)
        {
            if (ModelState.IsValid)
            {
