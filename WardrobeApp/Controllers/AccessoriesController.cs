...
namespace WardrobeApp.Controllers
{
    public class AccessoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AccessoryID,AccessoryName,AccessoryColor,AccessoryPhoto")] Accessory accessory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AccessoryID,AccessoryName,AccessoryColor,AccessoryPhoto")] Accessory accessory)
        {
            if (ModelState.IsValid)
            {
