...
namespace WardrobeApp.Controllers
{
    public class ShoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ShoesID,ShoeName,ShoeColor,ShoePhoto")] Shoe shoe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ShoesID,ShoeName,ShoeColor,ShoePhoto")] Shoe shoe)
        {
            if (ModelState.IsValid)
            {
